...
事实上，基金委近年来的系列改革已显示出对传统同行评审局限的积极回应。原创探索计划引入预申请阶段双盲评审与评审意见答复机制，《2026年度国家自然科学基金原创探索计划项目申请指南》更是明确“对原创性强、\textbf{难以通过常规评审机制}获得资助的项目设立\textbf{专门渠道}，遴选具有\textbf{非共识、颠覆性、高风险}等特征的原创探索计划项目”；基金委绩效评价报告建议探索“分阶段评审”，使评审专家在评议创新性之后再参考前期研究基础；\cite{BaochenzhouHRC2023}明确建议在原创探索类项目中试点底线评审方法。这些改革共同指向降低排序竞争对评审判断和申请行为的扭曲，为探索“减少排序压力、优化程序设计”的机制创新提供了政策窗口。在中国情境下，关于进一步“减少排序、引入随机性”的讨论仍面临多重现实顾虑：例如，担忧质量把关与申请激励受损、担忧程序透明度不足引发信任危机、担忧评审者在筛选阶段出现标准松动等等。这些顾虑的共同根源，在于\textbf{缺乏足以令人信服的微观行为证据}。因此，有必要在中国可识别的制度与文化语境下，以行为经济学的理论框架与实验方法为核心工具，系统检验部分随机机制对评审者、申请者以及资助结构的影响，为改革路径的选择提供可操作、可验证、可推广的证据基础。
