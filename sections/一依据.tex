...
科学研究是推动社会进步和技术创新的核心动力，而科研资助制度则是决定科研资源配置效率的关键。当前，国内外主流科研资助体系通常依赖同行评审（peer review）下的竞争性排序：评审专家基于对申请书科学价值、创新性与可行性申请综合评估，对申请项目进行排序，资助机构再依据排序结果确定最终资助对象。然而，随着科研竞争的加剧和申请数量的激增，该机制面临日益严峻的理论困境与实践挑战。
...
\textbf{申请者面临的困境} \quad 评审端的噪声与偏见进一步塑造了申请者的策略行为。在竞争性排序框架下，申请者可能产生两类典型的行为扭曲。\textul{其一，文书投入的军备竞赛。}当产出难以精确测度时，强激励可能诱导代理人将努力投入于可观测但非生产性的活动\citep{holmstromMoralHazardObservability1979}。科研资助情境下，研究者可能将过多精力投入于申请书“包装”而非实际研究，而在低资助率下每一个项目所消耗的申请工作量极为可观\citep{schweigerCostsCompetitionDistributing2024}，由此挤占科研时间，并可能引发心理健康与不当研究行为等连带问题。\textul{其二，选题保守化。}在低资助率与强排序竞争的环境下，研究者倾向于理性地回避高风险高回报的选题，转而选择更安全、可预期的研究路径，甚至可能导致高质量申请者的自我排除\citep{wangFundingModelCreativity2018, grossContestModelsHighlight2019, addaGrantmakingGradingCurve2024}。

\textbf{系统层面的恶性循环} \quad 评审者偏差与申请者策略相互强化，形成一个自我加强的负向循环：\textbf{评审更保守$\to$申请更保守$\to$更多文书打磨、提案分布更趋同$\to$评审更依赖“成熟信号”与“安全路径”$\to$进一步压制高风险创新。}该循环不仅解释了“安全型研究”激励的强化，也揭示了高强度竞争环境中文书投入膨胀与研究方向趋同的深层机制。更为根本的问题是：\textbf{真正具有突破性的研究往往具有高不确定性，而这种研究往往在排序竞争中被系统性排斥。}\cite{whitleyImpactChangingFunding2018}通过跨国比较研究发现，竞争性项目资助占比的上升往往伴随资助框架的标准化，从而使偏离主流范式的研究越来越难以获得支持。\textul{这意味着，除效率损失之外，高强度排序竞争还可能从根本上抑制科学体系的创新性和多样性。}
...
在此背景下，\textbf{“合格筛选+随机抽签”（以下称为“部分随机”）}\footnote{国内已有学者将类似机制概括为“底线评审”\citep{BaochenzhouHRC2023, liu2021peerreview}，国际文献中则存在partial lottery与modified lottery两种表述。本项目采用“部分随机”一词。理由在于：“底线评审”侧重描述评审端从“择优”向“择差”的转变，未能涵盖分配端随机性的引入；“改良抽签”（对应modified lottery）中的“改良”仅表明对传统机制有所变动，未能揭示变动的实质方向。“部分随机”（对应partial lottery）则兼顾评审端的简化与分配端的随机化，且“部分”一词直接体现该机制并非完全随机，语义更为精确。}正逐渐成为改革选项。其核心设计是：\textbf{评审专家仅对申请作出合格/不合格的二元判定，据此剔除不达标申请，最终资助对象通过抽签的方式从合格项目中产生。}该设计在保留同行评审质量把关功能的同时，避免在噪声主导区间进行低效排序，并可能带来多方面收益，包括降低评审的认知负荷、抑制文书军备竞赛、缓解马太效应以及增强风险承担激励等。
...
然而，关于部分随机机制如何影响评审者判断、申请人策略以及最终科研产出，现仍缺乏系统性的证据。当评审专家知晓最终资助将以随机方式决定时，其筛选标准与评判行为是否会相应调整？在竞争框架发生转换的情形下，申请人是否会改变选题风险取向与文书投入策略？这一机制转换最终能否提升资助项目的创新性与多样性？上述问题缺少直接的实验识别与可复制的实证证据，因此亟需围绕相关行为机制开展进一步研究。

\section{\textbf{国内外研究现状及发展动态}}

\subsection{\textbf{同行评审中的评审者偏差}}

大量研究从不同角度揭示了同行评审中的系统性偏差：对新颖性与高风险项目的低估、对负面信息的过度反应、对申请者声誉与既往成就的依赖，以及由此引发的马太效应与累积优势。这些研究共同表明：\textul{在不确定性较高、信息不完备的环境中，评审者并非总能做出“中性、稳定、可重复”的质量判断。}

\textbf{评审噪声} \quad 竞争性排序机制要求评审者完成的精细区分，在统计意义上缺乏可靠性。 \cite{kahnemanNoiseFlawHuman2021} 系统论证了专家判断中噪声的普遍性，指出评审者间差异是评分异质性的主要来源。 \cite{galloInfluencePeerReviewer2016}对美国生物科学研究所(American Institute of Biological Sciences，AIBS)的资助评审数据分析表明，评审分数中约 23\% 的异质性可归因于申请质量，剩余约 77\% 来自评审者间差异和噪声。\cite{pierLowAgreementReviewers2018}通过让多组评审专家独立评估同一批对美国国立卫生研究院（National Institutes of Health，NIH）的申请，发现不同评审组之间的评分一致性极低，进一步证实了评审噪声问题的严重性。\cite{schweigerCostsCompetitionDistributing2024}指出同行评审虽能区分“优秀”与“不合格”的申请，但在顶尖申请之间的甄别能力极为有限。\cite{liBigNamesBig2015}的研究虽然发现评审分数与未来产出之间存在正相关，但同时指出评审者难以有效预测哪些项目将产生突破性成果。
...
\textbf{光环效应与累积优势} \quad 评审者倾向于依据申请者的既往声誉而非项目本身质量进行判断，形成马太效应。 \cite{bolthijsMatthewEffectScience2018}对荷兰科学研究组织（Netherlands Organization of Scientific Research，NWO）数据的分析显示，知名科学家的申请获得高分的概率显著高于同等质量的不知名科学家的申请。\cite{TianJiYuDIDMoXingDeKeJiZhengCeChuangXinNengLiZiZhuXiaoYingShiZhengYanJiuYiJieQingJiJinDiQiuKeXueXiangMuWeiLi2018}基于DID模型对杰青基金地球科学项目的评估发现，人才类资助对受资助者的创新能力具有显著正向效应，但这一效应主要惠及已获得资助的“赢家”，客观上加剧了资源集中。\cite{qiuMatthewEffectResearch2023}对NIH资助动态的研究表明，早期获得资助的研究者在后续竞争中具有显著优势，这种累积效应在职业生涯早期尤为明显。\textul{然而，目前尚无明确证据表明，这些累积优势最终会转化为相应的科研产出。}\cite{mongeonConcentrationResearchFunding2016}的研究表明，获得最多资助的精英研究人员在产出和影响力方面并无突出优势。\cite{aagaardConcentrationDispersalResearch2020}通过系统性文献综述发现，科研资助的集中化趋势并未带来相应的产出效益提升，反而可能使边际收益递减。

\subsection{\textbf{申请者对资助规则的策略反应}}

在申请者视角下，科研资助制度可被视为一类具有明确激励结构的竞赛（contest）。在申请成本为正且获资助概率不确定的情况下，研究者会依据评审标准与预期资助概率进行理性权衡。既有研究表明，\textul{资助规则不仅决定资源配置结果，还会通过影响进入决策、时间投入结构以及研究选题取向而影响科研产出。}


\textbf{自我选择} \quad \cite{addaGrantmakingGradingCurve2024}构建了科研资助中非市场资源配置的理论模型，并利用欧洲研究理事会（European Research Council，ERC）评审规则变动作为自然实验加以检验。研究发现，当评审噪声上升时，申请数量反而增加；而当评审精度较高时，高质量申请者可能因预期竞争强度上升、净收益降低而自我排除。这一反直觉的结果源于申请者的策略选择：排序的不确定性越高，部分申请者反而更倾向于进入以期通过“运气”获得资助。
...
\textbf{国际实践探索} \quad 近年来，多个科研资助机构已将部分随机纳入正式流程。新西兰健康研究理事会（Health Research Council of New Zealand，HRC）自2013年起在其Explorer Grants计划中仅要求评审判断申请是否合格，所有合格申请通过软件随机数抽签资助；大众基金会（Volkswagen Foundation，VF）于2017年在Experiment!计划中引入质量审查后的实体抽签环节，并设置wild-card机制允许评审团在抽签之外单独决定资助个别项目；瑞士国家科学基金会（Swiss National Science Foundation，SNSF）于2018年在Postdoc.Mobility计划中试行对评审未能区分优劣的合格申请采用抽签分配；奥地利科学基金会（Austrian Science Fund，FWF）自2019年起在1000 Ideas Programme中采用混合设计，由评审直接选出部分高质量项目，其余同等价值的合格项目通过抽签决定。\footnote{关于上述四项计划的详细机制描述与比较，参见 \cite{bendiscioli2022experimental}。}这些实践在机制细节上各有差异，但共享“合格筛选+随机抽签”的核心逻辑。\cite{gigerenzerAlternativeModelsFunding2025}在对上述实践及更广泛替代资助模型的综合讨论中指出，\textul{引入随机性是应对评审者间一致性偏低问题的一项更为根本性的改革方案之一；但同时也强调，目前尚不存在单一最优的好奇心驱动研究（curiosity-driven research）资助机制，且对替代模型开展系统性实证评估的研究仍显不足。}

\textbf{创新激励的复杂效应} \quad 部分随机对创新行为的影响并非单向度。\textul{一方面，随机性降低了资助结果的可预测性，可能削弱过度包装与风险规避的动机。}\cite{mansoMotivatingInnovation2011}指出对早期失败的容忍是激励创新的关键机制，\cite{edererPayPerformanceDetrimental2013}在实验室环境中验证了这一预测，发现“容忍早期失败+奖励长期成功”的激励方案显著提升了探索行为。\cite{azoulayIncentivesCreativityEvidence2011}通过比较霍华德·休斯医学研究所（Howard Hughes Medical Institute，HHMI）研究员与NIH资助者进一步表明，容忍失败的资助模式能显著促进高影响力成果与探索性创新。\textul{另一方面，若申请者将结果理解为“主要由运气决定”，则可能削弱其投入高质量申请的激励，诱发逆向选择。}\cite{charnessCreativityIncentives2019}的实验研究则指出，激励机制对创造力的影响取决于任务结构：竞赛激励在约束较强的封闭型任务中有助于提升创造力，而在开放型任务中效果不显著，同伴排名等非金钱激励反而更为有效。这些证据提示，部分随机对创新的影响可能取决于研究类型、任务结构与激励强度之间的匹配关系，有必要通过更精细的机制设计与实验识别加以检验。
...
% 尽管部分随机资助机制在理论与实践层面均取得一定进展，但现有研究存在三方面显著局限。

% \textbf{第一，缺乏对部分随机机制行为效应的直接实验证据。} 如前文所述，现有研究或侧重规范性论证与机制设计，或通过模拟评估不同抽签设计的公平性与正确性，或依赖事后行政数据的描述性分析。目前唯一直接比较部分随机与传统排序产出效果的随机对照试验是\cite{barnettImpactWinningFunding2024} 对新西兰 HRC 项目的评估，但样本量有限（88 名研究者），且未能系统测量申请者的心理与行为反应。现有文献尚未在可控条件下识别部分随机机制对评审者判断与申请者策略的因果效应，也缺乏可供复制的行为测量数据。

% \textbf{第二，关于竞争排序与风险承担关系的理论预测存在未解决的分歧。} \cite{grossContestModelsHighlight2019} 的竞赛模型预测低资助率下研究者将理性地放弃高风险选题，竞争导致选题保守化； \cite{wangFundingModelCreativity2018}与 \cite{LiGaoFengXianGaoHuiBaoXiangMuZiZhuYouZhuYuKeYanChuangXinMaJiYuKeXueDaShuJuDeWenXianOuHeWangLuoFenXi2025} 的实证发现在方向上与此一致。然而， \cite{hvide2002tournament}在经典 Lazear-Rosen 排序竞赛赛框架 \citep{lazear1981rankorder}中引入风险选择维度后得出截然不同的结论：当参赛者可同时选择努力水平与产出分布的离散度时，均衡结果为过度冒险且低努力——竞争性排序未必抑制风险承担，反而可能诱发高风险与低努力并存的策略组合。\textul{这一理论分歧提示：部分随机机制对行为的影响可能不是单向度的——它在降低排序压力的同时，究竟主要缓解了选题保守化，还是可能削弱努力投入激励，抑或两种效应在不同参数条件下此消彼长，亟需通过实验识别加以解答。}

% \textbf{第三，对中国情境的适用性研究系统缺失。} 现有关于部分随机机制的理论建模、实验研究与实践案例几乎全部基于欧美和大洋洲的科研资助体系。然而，中国科研资助环境具有鲜明的制度特殊性：资助率持续走低且申请量急速攀升、绩效考核高度量化且与职称晋升紧密挂钩、人才项目与项目资助并行交织。在此背景下，评审者的判断模式、申请者的参照点与风险偏好结构可能与既有研究样本存在系统性差异，而现有文献对此缺乏关注。

尽管部分随机资助机制在理论与实践层面均取得一定进展，但现有研究仍存在三方面显著局限。

\textbf{第一，缺乏对部分随机机制行为效应的直接实验证据。}如前文所述，现有研究或侧重规范性论证与机制设计，或通过模拟评估不同抽签设计的公平性，或依赖事后行政数据的描述性分析。目前唯一直接测度该机制产出效果的随机对照试验是 \cite{barnettImpactWinningFunding2024} 对新西兰 HRC 项目的评估，但样本量有限（88名研究者），且未系统测量申请者的心理与行为反应。总体而言，现有文献尚未在可控条件下识别部分随机机制对评审者判断与申请者策略的影响。

\textbf{第二，关于竞争排序与风险承担关系的理论预测存在未解决的分歧。}\cite{grossContestModelsHighlight2019} 预测低资助率下研究者将理性地回避高风险选题，竞争导致选题保守化；\cite{wangFundingModelCreativity2018} 与 \cite{LiGaoFengXianGaoHuiBaoXiangMuZiZhuYouZhuYuKeYanChuangXinMaJiYuKeXueDaShuJuDeWenXianOuHeWangLuoFenXi2025} 的实证发现与此方向一致。然而，\cite{hvide2002tournament} 在经典 Lazear-Rosen 排序竞赛框架 \citep{lazear1981rankorder} 中引入风险选择维度后得出截然不同的结论：当参赛者可同时选择努力水平与产出分布的离散度时，均衡结果为过度冒险伴随低努力——竞争性排序未必抑制风险承担，反而可能诱发高风险与低努力并存的策略组合。\textul{这一分歧提示，部分随机机制对行为的影响可能并非单向度：它在降低排序压力的同时，究竟主要缓解选题保守化，还是削弱努力投入激励，抑或两种效应在不同条件下此消彼长，亟需通过实验识别加以解答。}

\textbf{第三，对中国情境的适用性检验系统缺失。}现有理论建模、实验研究与实践案例几乎全部基于欧美和大洋洲的科研资助体系，而中国科研资助环境具有鲜明的制度特殊性——资助率持续走低且申请量急速攀升、绩效考核高度量化且与职称晋升紧密挂钩、人才资助与项目资助并行交织。在此背景下，评审者的判断模式与申请者的风险偏好结构可能与既有研究样本存在系统性差异，现有文献对此尚缺乏关注。
...
% 事实上，基金委近年来的系列改革已显示出对排序化评审局限的清醒认识与积极回应。在评审质量维度，``负责任、讲信誉、计贡献''（RCC）评审机制自2020年在10个学科启动试点，至2024年已在全委范围全面推行，通过评审专家信誉档案与申请人反馈机制形成双向约束。在评审标准维度，基于四类科学问题属性的分类评审自2022年起覆盖逾85\%的申请项目；《关于2026年度国家自然科学基金项目申请与结题等有关事项的通告》进一步将研究属性简化为``自由探索类基础研究''与``目标导向类基础研究''两类，并同步推进申请书``瘦身提质''改革，将正文精简为立项依据、研究内容、研究基础三大部分，明确鼓励申请人摒弃``套路''与``话术''。在评审机制维度，原创探索计划引入预申请阶段双盲评审与评审意见答复机制；《2026年度国家自然科学基金原创探索计划项目申请指南》（国科金发计〔2026〕24号）更启动``重大非共识项目''试点，采用非常规遴选模式资助颠覆性创新；基金委绩效评价报告亦建议探索``分阶段评审''，使评审专家在评议创新性之后再参考前期研究基础。 \cite{BaochenzhouHRC2023}进一步明确建议基金委在原创探索类项目中试点底线评审方法。这些改革共同指向一个方向：\textbf{降低排序竞争对评审判断和申请行为的扭曲}。然而，现有改革仍在传统同行评审范式之内，其核心逻辑是优化评审过程与标准，而非从根本上改变``精细排序决定资助''的分配逻辑。在中国情境下，关于进一步``减少排序、引入随机性''的讨论仍面临三重现实顾虑：其一，担忧质量把关与申请激励受损；其二，担忧程序透明度不足引发信任危机；其三，担忧评审者在筛选阶段出现标准松动。这些顾虑的共同根源，在于\textbf{缺乏足以令人信服的微观行为证据}。因此，有必要在中国可识别的制度与文化语境下，以行为经济学的理论框架与实验方法为核心工具，系统检验部分随机机制对评审者判断与申请者策略的因果效应，为改革路径的选择提供可操作、可验证、可推广的证据基础。

事实上，基金委近年来的系列改革已显示出对传统同行评审局限的积极回应。原创探索计划项目引入预申请阶段双盲评审与评审意见答复机制，《2026年度国家自然科学基金原创探索计划项目申请指南》更是明确\textbf{“对原创性强、难以通过常规评审机制获得资助的项目设立专门渠道，遴选具有非共识、颠覆性、高风险等特征的原创探索计划项目”}；基金委绩效评价报告建议探索“分阶段评审”，使评审专家在评议创新性之后再参考前期研究基础；\cite{BaochenzhouHRC2023}明确建议在原创探索类项目中试点底线评审方法。这些改革建议为探索“减少排序压力、优化程序设计”的机制创新提供了政策窗口。\textul{在中国情境下，关于“引入随机性”的讨论仍面临多重现实顾虑：例如，担忧质量把关与申请激励受损、担忧程序透明度不足引发信任危机、担忧评审者在筛选阶段出现标准松动等。这些顾虑的共同根源，在于缺乏足以令人信服的微观行为证据。}因此，有必要在中国可识别的制度与文化语境下，以行为经济学的理论框架与实验方法为核心工具，系统检验部分随机机制对评审者、申请者以及资助结构的影响，为改革路径的选择提供可操作、可验证、可推广的证据基础。
